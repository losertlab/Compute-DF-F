function [norm_meanIMG,roiBW2,npBWout,DFF,normF,npSubFluoSmooth,xcRaw,ycRaw,minNpSubFluo,maxAdjF] = computeDFF_filled(RegImg,frameRate,xc,yc,expectedNeuronRadiusPix,winsize,percentBaselineSub)
